package com.dinnersolutions.feasted;
...
public class MainActivity extends AppCompatActivity implements
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            mAuthManager.saveBearerToken(acct.getIdToken());

            mFeastedApi.getTokenAndUser(new Callback<TokenUserResponse>() {
                @Override
